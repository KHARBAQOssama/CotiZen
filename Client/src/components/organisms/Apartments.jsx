              ...
              <tbody>
                {apartments.map((apartment) => (
                  <tr key={apartment._id} className="w-max relative">
                    ...
                    <td className="bg-white py-2 px-4 w-max max-w-[20ch] text-ellipsis overflow-hidden whitespace-nowrap">
                      {apartment.address}
                    </td>
                    ...
                    <td className="bg-white py-2 px-4 w-max flex gap-2">
                      ...
                      <button
                        onClick={() => {
                          setToEdit(apartment._id);
                        }}
                        className="p-1 px-2 bg-yellow-200 rounded-md text-yellow-600"
                      >
